            ...
            {!!Form::open(array('route'=>'course.store','class'=>'form-horizental'))!!}
               {!! csrf_field() !!}
                ...
                <div class="well well-sm"><strong><span class="glyphicon glyphicon-asterisk"></span>Required Field</strong></div>
                    <h3 class="sign-up-title" style="color:dimgray; text-align: center">Department Information</h3>
                        
                    <hr class="colorgraph">
                    <input for="amount" class="form-control dept-code" placeholder="Department-code" name="dept_code" id="InputName" type="text" required>
                    <input class="form-control" placeholder="Department-name" name="dept_name" id="InputName"type="text" required>
                    <input class="form-control" placeholder="Building No" name="building_no" id="InputName"type="text" required>
                    <input class="btn btn-lg btn-success btn-block" type="submit" value="Add Department Information">
                </fieldset>
            {!!Form::close()!!}
        </div>
    </div>
